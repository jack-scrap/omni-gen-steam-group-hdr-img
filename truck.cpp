...
Truck* truckMk(glm::vec3 loc, glm::vec3 rot) {
	...
	child[w * 2] = objMk("truck/tail", "obj", "dir", true, glm::vec3(-(2 * layout::idx[Z]) - (layout::stroke * 2), -layout::stroke, 0.0), rot);
...
Truck* truckMk(char* init, unsigned int no, glm::vec3 loc, glm::vec3 rot) {
	...
	// bed
	Obj* bed = ptMk(Truck::_vtx, "main", "bed", "dir", false, glm::vec3(0.0), glm::vec3(0.0, M_PI / 2, 0.0));
	...
	Obj* outer = ptMk(Truck::_vtx, "main", "outer", "dir", true, glm::vec3(0.0), glm::vec3(0.0, M_PI / 2, 0.0));
	...
	child[2] = objMk("truck/tail", "obj", "dir", true, glm::vec3(-(no * layout::idx[Z]) - (layout::stroke * 2), -layout::stroke, 0.0), rot);
