...
STATIC = main disp util mesh console var str border node cont idx arr dict lim cone road state layout i_beam bound omni
DYNA = scn prog line pt obj crane truck cargo_ship street_light
